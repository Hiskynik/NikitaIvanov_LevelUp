...
class OpenMailTopicTest {
    ...
    void workWithTopicMail() throws InterruptedException {
        ...
        //System.out.println(a + " - количество писем до сохранения в папку Тест");
        ...
        //System.out.println(d + " - количество писем после отправки в папке Отправленные");
        int mySendLetter = 1;
        ...
        //System.out.println(b + " - количество писем после отправки в папке Тест");
